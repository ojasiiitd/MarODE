...
# python ROSCOE-LI_processor.py --input /home/ojas/scripts/datasets/Human_Eval/sample_exps/test.json --output /home/ojas/scripts/datasets/Human_Eval/sample_exps/test_li_norm.json --evidence true --gpu 1
