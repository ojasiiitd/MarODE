    ...
    for i, entry in enumerate(entries):
        ...
        try:
            ourmetric = {
                ...
                "quality_score": float(np.mean( [redundancy_scores[i] , verdict_scores[i]] ) ),
                "evidence_score": float(evidence_scores[i]),
                "total_score": float(
                    cfg.weights.coherence * coherence_scores[i] +
                    cfg.weights.quality * (np.mean( [redundancy_scores[i] , verdict_scores[i]] )) +
...
# python OurMetric.py --input /home/ojas/scripts/datasets/Human_Eval/sample_exps/Qwen_3B_CoT_1shot_sample_ptrb_baselines.json --output /home/ojas/scripts/datasets/Human_Eval/sample_exps/Qwen_3B_CoT_1shot_sample_ptrb_baselines.json --gpu 0 --evidence true

# python OurMetric.py --input /home/ojas/scripts/datasets/Human_Eval/sample_exps/test.json --output /home/ojas/scripts/datasets/Human_Eval/sample_exps/test_baselines.json --gpu 0 --evidence true
